...
-- ============================================================================
-- 0095 CLAIMTURN DESK (additive). Does NOT touch leads or /m6.
-- Full file: supabase/migrations/0095_claimturn_desk.sql
-- Preview demo runs from src/lib/turn/seed.ts even if this is not applied.
-- Brett applies; do not run from the agent.
-- ============================================================================
