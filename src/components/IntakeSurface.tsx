...
// but only for users a manager/admin has trusted with it via the `intake.full`
// permission (Users screen). Everyone else is held in guided, which is the right
// tool for a live call. We read the permission once on mount so a plain agent
// never even sees the switch.
// ============================================================================
