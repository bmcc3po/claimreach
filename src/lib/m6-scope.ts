...
export const M6_STATUS_COLUMNS =
  "lead_id, lead_no, claimant_name, health, days_overdue, days_since_contact, last_two_way_at, next_touch_due, ladder_step, retention_owner, live_contact_points, firm_id, campaign, case_type, archived_at";
